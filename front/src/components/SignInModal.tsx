...
const SignInModal:React.FC<IProps> = ({onEnterClick, onSubmit, onModalLinkClick} : IProps) => {
    ...
    return (
        ...
        >
            ...
            <span className={'modal__link__text'} onClick={onModalLinkClick}>Регистрация</span>
        </div>
    </div>
    )
}
